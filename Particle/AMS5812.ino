...
// AMS5812
// This code is designed to work with the AMS5812_I2CS_0008-D I2C Mini Module available from ControlEverything.com.
// https://www.controleverything.com/content/Pressure?sku=AMS5812_I2CS_0008-D#tabs-0-product_tabset-2
...
void loop()
{
  ...
  pressure = ((ptemp - 3277.0) / ((26214.0) / 0.8)) - 0.8;
